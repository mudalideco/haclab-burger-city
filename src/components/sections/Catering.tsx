...
export function Catering() {
  return (
    <section id="catering" className="bg-background py-20 md:py-28">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          >
            ...
            <div className="absolute bottom-6 left-6">
              <div className="rounded-xl bg-primary px-4 py-2 font-heading text-lg font-bold text-white shadow-lg">
                We Bring the Grill
              </div>
            </div>
          </motion.div>
